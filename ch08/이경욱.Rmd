...
ciga <- data.frame(한갑이상 = c(23, 31, 13, 67),
                       한갑이하 = c(21, 48, 23, 92),
                       안피움 = c(63,159, 119, 341),
                       계 = c(107, 238, 155, 500))
rownames(ciga) = c('반병이상', '반병이하', '못마심', '계')
chisq.test(ciga)

####정답####
# t.test결과 p-value값이 0.1706로 유의수준 0.05보다 크므로 영가설 채택.
# 즉, 음주량과 흡연량 사이에 연관이 있다

# 영가설 : 음주량과 흡연량 사이에 연관이 있다
# 대안가설 : 음주량과 흡연량 사이에 연관이 없다.
