...
sns.c <- read.csv("D:/Workspace/R-Statistics/ch08/data/snsbyage.csv", header=T, stringsAsFactors=FALSE)
str( sns.c )
...
chisq.test(c.tab) # 검정통계량, p-value 값 한번에 확인
